...
def configCLEVR():
    ...
    config.datasetFilename = "{tier}_questions.json"
    config.wordVectorsFile = \
    "{dataBasedir}/glove/glove.6B.{dim}d.txt".format(
        dataBasedir=config.dataBasedir, dim = config.wrdEmbDim) #
